...
if __name__ == "__main__":
    ...
    gene_embs = torch.load(
        "/ml_storage/jiaxin/catch_up/best_performance_ae/lfc_trying/embedding/encoded/1773295339.5583389.pt"
    )
    ...
    with np.load(
        "/ml_storage/jiaxin/catch_up/best_performance_ae/lfc_trying/embedding/mlp_predict_decoded/downstream_residual_swiglu_decoded.npz"
    ) as data:
    ...
    dataloader = torch.utils.data.DataLoader(
        dataset, batch_size=512, shuffle=False, num_workers=4, pin_memory=False
    )
